python supervised_algorithms.py  -i ../../Datasets/Realdata_3Times3FoldsExp_TrainS01 -p ../Parameters/SVM_MLP_0 -n 7 -o 3Times3FoldsExp_Train -s 0.01
python supervised_algorithms.py  -i ../../Datasets/Realdata_3Times3FoldsExp_TrainS05 -p ../Parameters/SVM_MLP_0 -n 7 -o 3Times3FoldsExp_Train -s 0.05
python supervised_algorithms.py  -i ../../Datasets/Realdata_3Times3FoldsExp_TrainS10 -p ../Parameters/SVM_MLP_0 -n 7 -o 3Times3FoldsExp_Train -s 0.10
